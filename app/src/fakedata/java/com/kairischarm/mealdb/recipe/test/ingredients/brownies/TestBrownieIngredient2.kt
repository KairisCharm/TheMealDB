...
class TestBrownieIngredient2(private val activity: Activity) : Ingredient {
    override fun getDescription(): String {
        return activity.getString(R.string.brownie_ingredient_2)
    }

    override fun getImage(): RequestCreator {
        return Picasso.get().load(R.drawable.sugar_small)
    }
}