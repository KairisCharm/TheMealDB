...
class TestBrownieIngredient3(private val activity: Activity) : Ingredient {
    override fun getDescription(): String {
        return activity.getString(R.string.brownie_ingredient_3)
    }

    override fun getImage(): RequestCreator {
        return Picasso.get().load(R.drawable.cocoa_small)
    }
}